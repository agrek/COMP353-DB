...
VALUES (4, 'TA', 35, 882108144, 1000),
       ...
       #(8, 'TA', 25, 445761402, 1000), GPA too low
       #(15, 'TA', 25, 964663021, 1200), GPA too low
       #(19, 'TA', 25, 964663021, 1200), GPA too low
       #(32, 'TA', 25, 964663021, 1200), GPA too low
       #(12, 'marker', 65, 934347739, 1000), GPA too low
       #(16, 'TA', 50, 934347739, 1000), GPA too low
       #(17, 'TA', 35, 786482339, 1000), GPA too low
       #(21, 'marker', 90, 786482339, 1300), GPA too low
       #(18, 'TA', 35, 809493224, 1000), GPA too low
       #(23, 'TA', 25, 809493224, 1000), GPA too low
       ...
       #(25, 'TA', 30, 426299656, 1000), GPA too low
       #(5, 'TA', 25, 357320964, 1000), GPA too low
       #(24, 'marker', 30, 357320964, 1000), GPA too low
       (27, 'marker', 30, '814392875', 1000),
       (28, 'TA', 80, 508203017, 1000),
       (30, 'marker', 80, 508203017, 1000),
       #(31, 'TA', 30, 656597000, 1000), GPA too low
       ...
       #(37, 'marker', 80, 403876313, 1050), GPA too low
       (39, 'marker', 100, 406932598, 1000),
       (40, 'Lab Instructor', 100, 406932598, 1000),
       (41, 'marker', 110, 683192608, 1000),
       (42, 'marker', 110, 683192608, 1000),
       #(43, 'marker', 110, 445761402, 1000), GPA too low
       #(44, 'marker', 110, 445761402, 1000), GPA too low
       #(45, 'marker', 120, 309348312, 1000), GPA too low
       (46, 'marker', 120, 204794691, 1000),
       #(47, 'marker', 120, 309348312, 1000), GPA too low
       #(48, 'marker', 90, 635804780, 1000), GPA too low
       #(49, 'marker', 90, 635804780, 1000), GPA too low
       (50, 'marker', 80, 146344051, 1000),
       (52, 'TA', 30, 177921799, 1000),
       (53, 'Lab Instructor', 30, 177921799, 900),
       #(51, 'marker', 90, 965277745, 1000), GPA too low
       (54, 'marker', 65, 249691790, 1000),
       (55, 'TA', 30, 249691790, 1100),
       (61, 'marker', 65, 249691790, 1000),
       #(56, 'marker', 30, 665452486, 1000), GPA too low
       #(57, 'TA', 30, 665452486, 1000), GPA too low
       #(59, 'marker', 90, 927819640, 1000), GPA too low
       #(60, 'TA', 25, 927819640, 1000), GPA too low
